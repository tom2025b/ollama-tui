...
impl App {
    ...
    pub fn scroll_up(&mut self, lines: usize) {
        self.ui.scroll_offset = self.ui.scroll_offset.saturating_add(lines);
    }

    /// Move the chat history view downward (toward newest messages).
    pub fn scroll_down(&mut self, lines: usize) {
        self.ui.scroll_offset = self.ui.scroll_offset.saturating_sub(lines);
    }
    ...
    pub fn toggle_help(&mut self) {
        ...
        self.ui.status = if self.ui.show_help {
    ...
    pub fn hide_help(&mut self) {
        ...
        self.ui.status = "Help closed.".to_string();
    }
